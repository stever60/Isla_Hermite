...
HER49L_xrf_comp <- read_csv("Papers/Hodgson_Hermite_2022/Data/ITRAX/Outputs/HER_ITRAX_COMPOSITE_cps.csv") %>%
  filter(Site == c("HER49L"))

HER49L_xrf_comp

write.csv(HER14L_xrf_comp,"HER49L/Output/Composite/HER14L_xrf_comp.csv", row.names = FALSE)
...
HER49L_elements <- select(HER49L_xrf_comp_qc, c(Mg:Mo_coh), -c(all_of(machine_elements), `Fe a*2`)) %>% # , Zr
  names()
HER49L_elements
...
HER49L_xrf <- HER49L_xrf_comp_qc %>%
  select(Site:MSE, any_of(HER49L_elements), qc) %>%
...
HER49L_xrf1_Z[, HER49L_elementsZ] <- scale(HER49L_xrf1[, HER49L_elementsZ], center = TRUE, scale = TRUE)
HER49L_xrf1_Z

# Standardise and centre inc normalised dataframe
HER49L_xrf1_inc_Z <- HER49L_xrf1_inc
HER49L_xrf1_inc_Z[, HER49L_elementsZ] <- scale(HER49L_xrf1_inc[, HER49L_elementsZ], center = TRUE, scale = TRUE)
HER49L_xrf1_inc_Z

# Standardize and center Ln Ti-normalized data
HER49L_xrf1_Ln_Ti_Z <- HER49L_xrf1_Ln_Ti
HER49L_xrf1_Ln_Ti_Z[, HER49L_elementsZ] <- scale(HER49L_xrf1_Ln_Ti[, HER49L_elementsZ], center = TRUE, scale = TRUE)
HER49L_xrf1_Ln_Ti_Z
