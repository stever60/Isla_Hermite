...
HER_Density_N  <- HER_MSCL_comp_density %>% 
  ...
  geom_line(aes(group = Site, colour = Site), linewidth = 0.5, alpha = 0.3) +
  #geom_point(aes(group = Site, colour = Site), linewidth = 0.5, alpha = 0.2) +
  geom_smooth(aes(group = Site, colour = Site), linewidth = 0.75 , span = 0.1, method = "loess") +
  #scale_fill_jco() +
  #scale_color_jco() +
...
HER42_Density_S <- HER_MSCL_comp_density %>% 
  ...
  ggplot(aes(x = mean_age, y = value)) +
  geom_line(aes(group = Site, colour = Site), linewidth = 0.5, alpha = 0.3) +
  #geom_point(aes(group = Site, colour = Site), linewidth = 0.5, alpha = 0.3) +
  geom_smooth(aes(group = Site, colour = Site), linewidth = 0.75 , span = 0.1, method = "loess") +
  #scale_fill_jama() +
  #scale_color_jama() +
...
HER_DCMS
ggsave("Papers/Hodgson_Hermite_2022/Figures/HER_DCMS_v2.pdf",
       height = c(12), width = c(12), dpi = 600, units = "cm")
...
HER42_ITRAX_S <- HER_ITRAX_xrf1_clr_comp1 %>% 
  ...
  geom_line(aes(group = Site, colour = Site), linewidth = 0.5, alpha = 0.3) +
  #geom_point(aes(group = Site, colour = Site), linewidth = 0.5, alpha = 0.2) +
  geom_smooth(aes(group = Site, colour = Site), slinewidthize = 0.75 , span = 0.1, method = "loess") +
  facet_geochem_grid(vars(param)) +
  #scale_fill_jama() +
  #scale_color_jama() +
  scale_fill_manual(values = jamaPBS1) +
...
HER_southern_4plots
ggsave("Papers/Hodgson_Hermite_2022/Figures/Fig3C_HER_southern_poster.pdf",
       height = c(16), width = c(10), dpi = 600, units = "cm")
